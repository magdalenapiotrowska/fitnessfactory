                  ...
                  <div class="col-md-4">
                    <div class="thumbnail">
                      ...
                      <div class="caption">
                        <h3>ZAJĘCIA</h3>
                        <p>...</p>
                        <p><a href="opisyzajec.php" class="btn button-log" role="button">Dowiedz się więcej</a></p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="thumbnail">
                      ...
                      <div class="caption">
                        <h3>ZAPISY ONLINE</h3>
                        <p>...</p>
                          <p><a href="grafikZAL.php" class="btn button-log" role="button">Zapisz się</a></p>
                      </div>
                    </div>
                  </div>
                    <div class="col-md-4">
                    <div class="thumbnail">
                      ...
                      <div class="caption">
                        <h3>SKLEP</h3>
                        <p>...</p>
                        <p><a href="sklep.php" class="btn button-log" role="button">Kup Karnet</a></p>
                      </div>
                    </div>
                  </div>
                </div>
